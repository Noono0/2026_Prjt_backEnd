...
public class NoticeBoardCommentController {
    ...
    public ApiResponse<List<BoardCommentDto>> listComments(
            @PathVariable Long noticeBoardSeq, @RequestParam(defaultValue = "latest") String sort) {
    ...
    public ApiResponse<Long> createComment(
            @PathVariable Long noticeBoardSeq, @RequestBody BoardCommentSaveRequest request) {
    ...
    public ApiResponse<Integer> likeComment(
            @PathVariable Long noticeBoardSeq, @PathVariable Long commentSeq) {
    ...
    public ApiResponse<Integer> updateComment(
            @PathVariable Long noticeBoardSeq,
