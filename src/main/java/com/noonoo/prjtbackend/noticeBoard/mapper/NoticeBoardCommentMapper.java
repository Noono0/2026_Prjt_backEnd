...
public interface NoticeBoardCommentMapper {
    ...
    List<BoardCommentDto> findNoticeBoardCommentsFlat(
            @Param("noticeBoardSeq") Long noticeBoardSeq,
    ...
    BoardCommentDto findNoticeBoardCommentById(
    ...
    int updateNoticeBoardComment(
            @Param("noticeBoardSeq") Long noticeBoardSeq,
            @Param("noticeBoardCommentSeq") Long noticeBoardCommentSeq,
            @Param("writerMemberSeq") Long writerMemberSeq,
            @Param("body") BoardCommentUpdateRequest body);

    int softDeleteNoticeBoardCommentThread(
            @Param("noticeBoardSeq") Long noticeBoardSeq,
            @Param("rootCommentSeq") Long rootCommentSeq);

    int softDeleteNoticeBoardCommentRow(
            @Param("noticeBoardSeq") Long noticeBoardSeq,
            @Param("noticeBoardCommentSeq") Long noticeBoardCommentSeq);

    int countEmoticonsForMember(@Param("memberSeq") Long memberSeq, @Param("ids") List<Long> ids);

    int countCommentsByNoticeAndMember(
            @Param("noticeBoardSeq") long noticeBoardSeq, @Param("memberSeq") long memberSeq);
}
