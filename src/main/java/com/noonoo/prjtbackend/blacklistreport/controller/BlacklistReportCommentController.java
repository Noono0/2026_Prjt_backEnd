...
public class BlacklistReportCommentController {
    ...
    public ApiResponse<List<BoardCommentDto>> listComments(
            @PathVariable Long blacklistReportSeq,
            @RequestParam(defaultValue = "latest") String sort) {
        List<BoardCommentDto> items =
                blacklistReportCommentService.findComments(blacklistReportSeq, sort);
    ...
    public ApiResponse<Long> createComment(
            @PathVariable Long blacklistReportSeq, @RequestBody BoardCommentSaveRequest request) {
    ...
    @PreAuthorize("@securityExpressions.canRead('" + MenuAuthorities.BLACKLIST_REPORT + "')")
    public ApiResponse<Integer> likeComment(
            @PathVariable Long blacklistReportSeq, @PathVariable Long commentSeq) {
    ...
    @PreAuthorize("@securityExpressions.canRead('" + MenuAuthorities.BLACKLIST_REPORT + "')")
    public ApiResponse<Integer> dislikeComment(
            @PathVariable Long blacklistReportSeq, @PathVariable Long commentSeq) {
    ...
    @PreAuthorize("@securityExpressions.canRead('" + MenuAuthorities.BLACKLIST_REPORT + "')")
    public ApiResponse<Integer> reportComment(
            @PathVariable Long blacklistReportSeq, @PathVariable Long commentSeq) {
    ...
    @PreAuthorize("@securityExpressions.canRead('" + MenuAuthorities.BLACKLIST_REPORT + "')")
    public ApiResponse<Integer> updateComment(
            @PathVariable Long blacklistReportSeq,
            @PathVariable Long commentSeq,
            @RequestBody BoardCommentUpdateRequest body) {
        int result =
                blacklistReportCommentService.updateComment(blacklistReportSeq, commentSeq, body);
