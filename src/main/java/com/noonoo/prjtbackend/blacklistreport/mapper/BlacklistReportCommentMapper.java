...
public interface BlacklistReportCommentMapper {
    ...
    List<BoardCommentDto> findBlacklistReportCommentsFlat(
            @Param("blacklistReportSeq") Long blacklistReportSeq,
    ...
    BoardCommentDto findBlacklistReportCommentById(
    ...
    int updateBlacklistReportComment(
            @Param("blacklistReportSeq") Long blacklistReportSeq,
            @Param("blacklistReportCommentSeq") Long blacklistReportCommentSeq,
            @Param("writerMemberSeq") Long writerMemberSeq,
            @Param("body") BoardCommentUpdateRequest body);

    int softDeleteBlacklistReportCommentThread(
            @Param("blacklistReportSeq") Long blacklistReportSeq,
            @Param("rootCommentSeq") Long rootCommentSeq);

    int softDeleteBlacklistReportCommentRow(
            @Param("blacklistReportSeq") Long blacklistReportSeq,
            @Param("blacklistReportCommentSeq") Long blacklistReportCommentSeq);

    int countCommentsByBlacklistReportAndMember(
            @Param("blacklistReportSeq") long blacklistReportSeq,
            @Param("memberSeq") long memberSeq);
