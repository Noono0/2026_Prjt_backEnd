...
public class BoardCommentController {
    ...
    public ApiResponse<List<BoardCommentDto>> listComments(
            @PathVariable Long boardSeq, @RequestParam(defaultValue = "latest") String sort) {
    ...
    public ApiResponse<Long> createComment(
            @PathVariable Long boardSeq, @RequestBody BoardCommentSaveRequest request) {
    ...
    public ApiResponse<Integer> likeComment(
            @PathVariable Long boardSeq, @PathVariable Long commentSeq) {
