...
public interface EventBattleMapper {
    ...
    List<EventBattleOptionDto> selectOptionsByEventSeq(
            @Param("eventBattleSeq") long eventBattleSeq);
    ...
    int incrementOptionPoints(
            @Param("eventBattleOptionSeq") long eventBattleOptionSeq, @Param("delta") long delta);
    ...
    int deleteMyVotes(
            @Param("eventBattleSeq") long eventBattleSeq, @Param("memberSeq") long memberSeq);

    List<Long> selectMyVoteOptionSeqs(
            @Param("eventBattleSeq") long eventBattleSeq, @Param("memberSeq") long memberSeq);
    ...
    List<EventBattleBettorRankDto> selectBettorRanking(
            @Param("eventBattleSeq") long eventBattleSeq, @Param("limit") int limit);
