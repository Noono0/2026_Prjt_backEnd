...
public class VisitorAnalyticsController {
    ...
    public ApiResponse<Void> heartbeat(
            @RequestBody VisitorHeartbeatRequest request, HttpServletRequest httpRequest) {
        String userAgent = httpRequest.getHeader("User-Agent");
        visitorAnalyticsService.heartbeat(
                request == null ? null : request.getVisitorKey(), userAgent);
