 ...
 *
 * <ul>
 *   <li>R2: {@code endpoint}=https://&lt;accountId&gt;.r2.cloudflarestorage.com, {@code
 *       path-style-access}=true, {@code region} 은 보통 {@code auto}
 *   <li>Lightsail Object Storage: 콘솔의 S3 호환 endpoint·리전·자격증명 사용
 * </ul>
 *
